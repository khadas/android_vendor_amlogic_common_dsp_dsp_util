...
#define CMD_FLATBUF_ARM2DSP_DSPC   0x32
#define CMD_FLATBUF_DSP2ARM_DSPC   0x33
#define CMD_APROCESS_OPEN_DSPC     0x34
#define CMD_APROCESS_CLOSE_DSPC    0x35
#define CMD_APROCESS_START_DSPC    0x36
#define CMD_APROCESS_STOP_DSPC     0x37
#define CMD_APROCESS_READ_DSPC     0x38
#define CMD_APROCESS_WRITE_DSPC    0x39
#define CMD_APROCESS_ALLOC_BUF_DSPC  0x3a
#define CMD_APROCESS_FREE_BUF_DSPC   0x3b
#define CMD_APROCESS_DQBUF_DSPC    0x3c
#define CMD_APROCESS_QBUF_DSPC     0x3d
#define CMD_APROCESS_GET_GAIN_DSPC 0x3e
#define CMD_APROCESS_SET_GAIN_DSPC 0x3f
...
#define MBX_CMD_FLATBUF_ARM2DSP_DSPC    __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_FLATBUF_ARM2DSP_DSPC)
#define MBX_CMD_FLATBUF_DSP2ARM_DSPC    __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_FLATBUF_DSP2ARM_DSPC)
#define MBX_CMD_APROCESS_OPEN_DSPC      __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_OPEN_DSPC)
#define MBX_CMD_APROCESS_CLOSE_DSPC     __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_CLOSE_DSPC)
#define MBX_CMD_APROCESS_START_DSPC     __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_START_DSPC)
#define MBX_CMD_APROCESS_STOP_DSPC      __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_STOP_DSPC)
#define MBX_CMD_APROCESS_READ_DSPC      __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_READ_DSPC)
#define MBX_CMD_APROCESS_WRITE_DSPC     __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_WRITE_DSPC)
#define MBX_CMD_APROCESS_ALLOC_BUF_DSPC    __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_ALLOC_BUF_DSPC)
#define MBX_CMD_APROCESS_FREE_BUF_DSPC     __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_FREE_BUF_DSPC)
#define MBX_CMD_APROCESS_DQBUF_DSPC   	 __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_DQBUF_DSPC)
#define MBX_CMD_APROCESS_QBUF_DSPC   	 __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_QBUF_DSPC)
#define MBX_CMD_APROCESS_GET_GAIN_DSPC   __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_GET_GAIN_DSPC)
#define MBX_CMD_APROCESS_SET_GAIN_DSPC   __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_APROCESS_SET_GAIN_DSPC)
