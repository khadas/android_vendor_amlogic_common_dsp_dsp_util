...
#define VSP_API_SEND       0x303
#define VSP_API_RECV       0x304
...
#define MBX_CODEC_VSP_API_SEND  __MBX_COMPOSE_MSG(MBX_CODEC, VSP_API_SEND)
#define MBX_CODEC_VSP_API_RECV  __MBX_COMPOSE_MSG(MBX_CODEC, VSP_API_RECV)
